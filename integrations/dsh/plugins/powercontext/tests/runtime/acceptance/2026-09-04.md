# DSH automatic-path acceptance — 2026-09-04
...
| --- | --- |
| PowerContext plugin implementation | `c25b6329`, based on A at `c776cddf564cc2b4c9b45d79a3e056fea26ddad8` |
| Built `lib/index.js` SHA-256 | `67ae2c96c2f03b4ce9b8d2e43dce47bcffaf588e5b80082346ce43443825c758` |
...
| Final plugin unit suite | 147 passed in 13 files, including 30 automatic-path regressions |
...
| Quality and documentation | Lock check, pre-commit hooks, type checks, manifest checks, strict documentation build and published OpenAPI equality passed |
...
The primary Web fixture's readiness response reported `inference.generation: unavailable` while
still returning both doctor checks. This was the earlier fixture's unsupported plain-text readiness
probe, not a claim that inference was healthy. The committed fixture now handles that probe.
